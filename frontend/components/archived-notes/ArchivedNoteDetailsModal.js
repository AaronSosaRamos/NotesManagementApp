...
const ArchivedNoteDetailsModal = ({ isOpen, onClose, note, onSave, onUnarchive, onDelete, availableCategories }) => {
  ...
  useEffect(() => {
    setValue('categories', categories.map(category => category.id));
  }, [categories, setValue]);
    ...
    <div className="fixed inset-0 z-10 overflow-y-auto">
      ...
      <div className="flex items-center min-h-screen px-4 py-8">
        <div className="relative w-full max-w-lg p-8 mx-auto bg-white rounded-md shadow-lg">
          ...
          <h2 className="text-2xl font-bold mb-4">Archived Note Details</h2>
...
export default ArchivedNoteDetailsModal;
